      ...
      <>
        ...
        <main className="article-page-wrapper">
          <div className="article-content-area" style={{ textAlign: 'center', paddingTop: '200px' }}>
            ...
            <Link href="/news" className="article-back-link" style={{ justifyContent: 'center' }}>
      ...
      <main className="article-page-wrapper">
        <div className="article-content-area">
          ...
          <div className="article-meta-row">
            <span className="article-meta-tag">{article.location}</span>
              ...
              if (item.type === 'image') {
                return (
                  <div 
                    ...
                    onClick={() => setLightboxImg(item.value)}
                    style={{ cursor: 'zoom-in' }}
                  >
                    <img src={item.value} alt={`${article.title} — image ${i + 1}`} />
                  </div>
                )
              }
              return null
